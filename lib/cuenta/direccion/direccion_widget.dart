...
class _DireccionWidgetState extends State<DireccionWidget> {
  ...
  void initState() {
    ...
    _model.textAddressController ??= TextEditingController();
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Por favor escriba su nueva dirección ',
                          style: FlutterFlowTheme.of(context)
                              .labelMedium
                              .override(
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            16.0, 16.0, 16.0, 0.0),
                        child: TextFormField(
                          controller: _model.textAddressController,
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Escriba su diredirección ',
                          ...
                          validator: _model.textAddressControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Padding(
                            ...
                            setState(() {
                              FFAppState().updateAuthUserStruct(
                                (e) => e
                                  ..updateAddresses(
                                    (e) => e
                                        .add(_model.textAddressController.text),
                                  ),
                              );
                            });
